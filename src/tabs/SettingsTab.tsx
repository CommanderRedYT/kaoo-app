...
export default function SettingsTab() {
    ...
    const dispatchWithSave = (action: AppThunk) => {
        dispatch(action);
        saveSettings();
    };
                ...
                <Box
                    ...
                    <Box
                        ...
                        <TextInput
                            ...
                            onChangeText={text =>
                                dispatch(updateChild(parseInt(text)))
                            }
                            keyboardType={'numeric'}
                        />
                    </Box>
                    <Box
                        ...
                        <TextInput
                            ...
                            onChangeText={text =>
                                dispatch(updateAdult(parseInt(text)))
                            }
                            keyboardType={'numeric'}
                        />
                    </Box>
